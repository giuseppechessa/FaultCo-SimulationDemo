...
if(args.o==1):
    ...
    plt.ylabel('Missprediction [%]')
    plt.ylim(0,100)
    plt.xticks( rotation=90)
    plt.savefig("./Missprediction.pdf", bbox_inches="tight")
    plt.figure() 
    max_width = 0.5
    auto_width = min(max_width, 0.8 / len(IDs))
    ...
    plt.ylim(0,100)
    plt.xticks( rotation=90)
    plt.ylabel('Missed/Added Spikes [%]')
    plt.savefig("./Missed-Added Spikes.pdf", bbox_inches="tight")
    con.close()